...
`kurtvalcorza/dimer-inference-service-timm`, copied verbatim from that repository
at commit `2b193c9`. The finetuner emits a manifest conforming to it next to
